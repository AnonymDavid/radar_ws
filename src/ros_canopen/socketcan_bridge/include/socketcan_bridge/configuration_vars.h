...
const int FILTERCFG_ACTIVE_VRELONCOME = 0;
...
const int FILTERCFG_ACTIVE_VRELDEPART = 0;
...
// Index 6. Objects
const int FILTERCFG_ACTIVE_LIFETIME = 0;
...
// Index 7. Objects
const int FILTERCFG_ACTIVE_SIZE = 0;
...
// Index 11. Objects
const int FILTERCFG_ACTIVE_VYRIGHTLEFT = 0;
...
// Index 12. Objects
const int FILTERCFG_ACTIVE_VXONCOME = 0;
...
// Index 13. Objects
const int FILTERCFG_ACTIVE_VYLEFTRIGHT = 0;
...
// Index 14. Objects
const int FILTERCFG_ACTIVE_VXDEPART = 0;
